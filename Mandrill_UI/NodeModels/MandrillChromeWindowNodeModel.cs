...
namespace Mandrill.ChromeWindow
{
    ...
    /// </summary>
    [NodeName("Report Chrome Window")]
    [NodeCategory("Archi-lab_Mandrill.Report.Window")]
    [NodeDescription("Use this node to launch a new chrome window that charts will be displayed in.")]
    [IsDesignScriptCompatible]
    [InPortNames("Report")]
    [InPortTypes("string")]
    [InPortDescriptions("Html report to render.")]
    public class MandrillChromeWindowNodeModel : NodeModel, INotifyPropertyChanged
    {
        /// <summary>
        ...
        {
            MandrillChromeWindow win = (MandrillChromeWindow)sender;
            MandrillChromeWindowNodeModel model = win.DataContext as MandrillChromeWindowNodeModel;
        ...
        /// </summary>
        public MandrillChromeWindowNodeModel()
        {
            RegisterAllPorts();
    ...
    /// </summary>
    public class MandrillWindowNodeViewCustomization : INodeViewCustomization<MandrillChromeWindowNodeModel>
    {
        private DynamoModel dynamoModel;
        private DynamoViewModel dynamoViewModel;
        private MandrillChromeWindowNodeModel mandrillNode;
        ...
        public void CustomizeView(MandrillChromeWindowNodeModel model, NodeView nodeView)
        {
            ...
            MandrillChromeWindowNodeModel.dv = FindUpVisualTree<DynamoView>(nodeView);
        ...
        private void CreateNewWindow()
        {
            ...
            {
                var mandrillWindow = new MandrillChromeWindow();
