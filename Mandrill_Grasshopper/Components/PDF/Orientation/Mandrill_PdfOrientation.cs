...
{
    public class Mandrill_PdfOrientation : GH_Param<IGH_Goo>, IGH_PreviewObject, IGH_StateAwareObject
    {
        private GH_ValueListMode m_listMode;
        private readonly System.Collections.Generic.List<GH_ValueListItem> m_userItems;
        private bool m_hidden;

        public Mandrill_PdfOrientation() : 
            base(new GH_InstanceDescription("PdfOrientation", "Orientation", 
