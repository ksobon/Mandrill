...
{
    public class Mandrill_PdfOrientationAttributes : GH_Attributes<Mandrill_PdfOrientation>
    {
        ...
        public Mandrill_PdfOrientationAttributes(Mandrill_PdfOrientation owner) : base(owner) { }
        ...
        private void RenderDropDown(GH_Canvas canvas, System.Drawing.Graphics graphics, System.Drawing.Color color)
        {
            ...
            Mandrill_PdfOrientationAttributes.RenderDownArrow(canvas, graphics, item.BoxRight, color);
        }
        ...
        private static void RenderDownArrow(GH_Canvas canvas, System.Drawing.Graphics graphics, System.Drawing.RectangleF bounds, System.Drawing.Color color)
        {
            ...
            var corners = array;
            Mandrill_PdfOrientationAttributes.RenderShape(canvas, graphics, corners, color);
        }
