...
{
    public class Mandrill_PdfSizeAttributes : GH_Attributes<Mandrill_PdfSize>
    {
        ...
        public Mandrill_PdfSizeAttributes(Mandrill_PdfSize owner) : base(owner) { }
        ...
        private void RenderDropDown(GH_Canvas canvas, System.Drawing.Graphics graphics, System.Drawing.Color color)
        {
            ...
            Mandrill_PdfSizeAttributes.RenderDownArrow(canvas, graphics, item.BoxRight, color);
        }
        ...
        private static void RenderDownArrow(GH_Canvas canvas, System.Drawing.Graphics graphics, System.Drawing.RectangleF bounds, System.Drawing.Color color)
        {
            ...
            Mandrill_PdfSizeAttributes.RenderShape(canvas, graphics, corners, color);
        }
