...
{
    public class Mandrill_GroupedBarChartStyle : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the Mandrill_GroupedBarChartStyle class.
        /// </summary>
        public Mandrill_GroupedBarChartStyle()
          : base("GroupedBarChartStyle", "Style",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            // create style
            var style = new GroupedBarChartStyle();
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.Charts_GroupedBarChart_Style;
            }
        }
        ...
        {
            get { return new Guid("{f5d1f06f-21f3-45ea-8a25-422a9909de26}"); }
        }
