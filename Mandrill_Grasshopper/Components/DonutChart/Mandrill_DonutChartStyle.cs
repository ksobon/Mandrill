...
{
    public class Mandrill_DonutChartStyle : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the Mandrill_DonutChartStyle class.
        /// </summary>
        public Mandrill_DonutChartStyle()
          : base("DonutChartStyle", "Style",
              "Donut Chart Style",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("TotalLabel", "TL", Resources.Style_TotalLabelDesc, GH_ParamAccess.item, "TOTAL");
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            DA.GetData(6, ref totalLabel);

            // create style
            var style = new DonutChartStyle();
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Resources.Charts_DonutChart_Style;
            }
        }
        ...
        {
            get { return new Guid("{9e5492cc-b544-4b7c-b6cd-e39a5316effb}"); }
        }
